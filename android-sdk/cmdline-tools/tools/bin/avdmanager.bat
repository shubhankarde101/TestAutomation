...
@rem ##########################################################################
@rem
@rem  avdmanager startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\/avdmanager-classpath.jar
...
:fail
rem Set variable AVDMANAGER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%AVDMANAGER_EXIT_CONSOLE%" exit 1
exit /b 1
