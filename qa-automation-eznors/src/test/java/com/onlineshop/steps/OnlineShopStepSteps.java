...
public class OnlineShopStepSteps extends BaseStep {
    ...
    public void user_launches_the_application_url() {
       ...
       Assert.assertEquals(driver.getTitle().trim(), "Swag Labs", "Page title not matched");
    ...
    public void standard_user_able_to_SignIn() {
        ...
        Assert.assertTrue(loginPage.verifyUserIsLoggedIn(), "User is unable to SignIn");
    ...
    public void locked_out_user_unable_to_SignIn(String expectedErrorMessage) {
        ...
        Assert.assertEquals(expectedErrorMessage, actualErrorMsg, "Locked out user is able to login which is a defect");
    ...
    public void problem_user_will_be_able_to_login_to_the_application_but_can_t_see_the_images_loaded() {
        ...
        Assert.assertTrue(loginPage.verifyImagesNotLoading(),"Images are wrongly loaded successfully");
        Assert.assertTrue(loginPage.verifyUserIsLoggedIn(), "User is unable to SignIn");
    ...
    public void user_will_checkout_with_proper_details() {
       Assert.assertEquals(productPage.checkoutAndContinue(),Double.toString(totalProductPrice),"Prices not matching");
    ...
    public void user_will_complete_the_order_after_verifying_the_total_price_of_the_order() {
        Assert.assertEquals(productPage.finishOrder(),"Thank you for your order!","Order not placed");
