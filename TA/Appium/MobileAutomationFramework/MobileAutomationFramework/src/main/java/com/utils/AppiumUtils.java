...
public class AppiumUtils {
	...
	// WAIT FOR MAX TIME 60 SECS TILL THE ELEMENT IS CLICKABLE - DISPLAYED AND
	// ENABLED
	public WebElement wait_until_MobileElementIs_Clickable(WebDriver driver, By locator) {
		log.info("60 secs - Waiting for element using -" + locator);
		wait = new WebDriverWait(driver, 60);
		return wait.until(ExpectedConditions.elementToBeClickable(locator));
	}

	// WAIT FOR MAX TIME 60 SECS TILL THE ELEMENT IS VISIBLE
	...
	public List<WebElement> wait_until_MobileElementsIs_Present(WebDriver driver, By locator) {
		log.info("60 secs - Waiting for element using -" + locator);
		wait = new WebDriverWait(driver, 60);
		// return wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
	...
	// WAIT FOR MAX TIME 60 SECS TILL THE ELEMENT IS PRESENT
	...
	public List<WebElement> wait_until_MobileElementsAre_Visible(WebDriver driver, By locator, int timeInSeconds) {
		log.info("5 secs - Waiting for elements using -" + locator);
		wait = new WebDriverWait(driver, timeInSeconds);
		return wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(locator));
	}

	public List<WebElement> wait_until_MobileElementsAre_Present(WebDriver driver, By locator, int timeInSeconds) {
		log.info("5 secs - Waiting for elements using -" + locator);
		wait = new WebDriverWait(driver, timeInSeconds);
		return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(locator));
	}
	...
	public List<WebElement> android_returnMobileElementsPresentDomUsingXPath(String xpath) {
		log.info("Trying to locate elements using x-path - " + xpath);
		return wait_until_MobileElementsAre_Present(driver, MobileBy.xpath(xpath));
	}
	...
	public void android_clearNotifications() {
		...
		if (android_isMobileElementPresentUsingText("CLEAR ALL")) {
			wait_until_MobileElementIs_Clickable(driver,
					MobileBy.AndroidUIAutomator("new UiSelector().text(\"CLEAR ALL\")")).click();
	...
	public MobileElement android_ScrollToText(String text) {
		...
		MobileElement el = (MobileElement) wait_until_MobileElementIs_Visible(driver, MobileBy
				.AndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"" + text + "\"));"));
		return el;
	}

	public List<WebElement> android_ScrollToContentDesc(String contentDesc) {
		log.info("Trying to scroll to element with content desc - " + contentDesc);
		List<WebElement> el = wait_until_MobileElementsIs_Present(driver, MobileBy.AndroidUIAutomator(
	...
	public MobileElement android_scrollToID(String id) {
		...
		MobileElement el = (MobileElement) wait_until_MobileElementIs_Visible(driver, MobileBy
				.AndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(resourceId(\"" + id + "\"));"));
		return el;
	}
	...
	public MobileElement android_scrollToTextInsideElementWithResourceID(String resourceID, String text) {
		log.info("Trying to scroll to android element with text - " + text);
		// make sure u give the resouce ID of the complete list of elements here as
		// parameter

		MobileElement el = (MobileElement) wait_until_MobileElementIs_Visible(driver,
				MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()" + ".resourceId(\"" + resourceID
						+ "\")).scrollIntoView(" + "new UiSelector().text(\"" + text + "\"));"));
		return el;
	}

	public MobileElement android_scrollToTextInsideElementWithContentDesc(String contentDesc, String text) {
		log.info("Trying to scroll to android element with contentDesc - " + contentDesc);
		// make sure u give the resouce ID of the complete list of elements here as
		// parameter

		MobileElement el = (MobileElement) wait_until_MobileElementIs_Visible(driver,
				MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()" + ".description(\"" + contentDesc
						+ "\")).scrollIntoView(" + "new UiSelector().text(\"" + text + "\"));"));
		return el;
	}
	...
	public MobileElement android_scrollToTextInsideElementWithID(String id, String text) {
		...
		MobileElement el = (MobileElement) wait_until_MobileElementIs_Visible(driver,
				MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()" + ".resourceId(\"" + id
						+ "\")).scrollIntoView(" + "new UiSelector().text(\"" + text + "\"));"));
		return el;
	}
	...
	public void android_HomeKeyEvent() {
		...
		((AndroidDriver) driver).pressKey(new io.appium.java_client.android.nativekey.KeyEvent(AndroidKey.HOME));
		sleep(2);
	}

	public void android_BackKeyEvent() {
		log.info("android back event");
		((AndroidDriver) driver).pressKey(new io.appium.java_client.android.nativekey.KeyEvent(AndroidKey.BACK));
		sleep(2);
	}

	public void android_Enter() {
		log.info("android Enter event");
		((AndroidDriver) driver).pressKey(new io.appium.java_client.android.nativekey.KeyEvent(AndroidKey.ENTER));
		sleep(2);
	}

	public void android_Tab() {
		log.info("android Tab event");
		((AndroidDriver) driver).pressKey(new io.appium.java_client.android.nativekey.KeyEvent(AndroidKey.TAB));
		sleep(2);
	}

	public void android_MultiTaskingKeyEvent() {
		((AndroidDriver) driver).pressKey(new io.appium.java_client.android.nativekey.KeyEvent(AndroidKey.APP_SWITCH));
		sleep(2);
	}
	...
	public boolean android_isMobileElementPresentUsingText(String text) {
		...
		try {
			log.info("Trying to find element with text - " + text);
			if (wait_until_MobileElementsAre_Visible(driver,
					(MobileBy.AndroidUIAutomator("new UiSelector().text(\"" + text + "\")")), 5).size() >= 1) {
	...
	public boolean android_isMobileElementPresentUsingID(String id) {
		...
		try {
			if (wait_until_MobileElementsAre_Visible(driver,
					(MobileBy.AndroidUIAutomator("new UiSelector().resourceId(\"" + id + "\")")), 5).size() >= 1) {
	...
	public boolean android_isMobileElementPresentUsingContentDesc(String contentDesc) {
		try {
			log.info("Trying to locate element using content-desc - " + contentDesc);
			if (wait_until_MobileElementsAre_Visible(driver,
					(MobileBy.AndroidUIAutomator("new UiSelector().description(\"" + contentDesc + "\")")), 5)
							.size() >= 1) {
	...
	public boolean android_isMobileElementPresentUsingXpath(String xPath) {
		try {
			...
			if (wait_until_MobileElementsAre_Present(driver, (MobileBy.xpath(xPath)), 5).size() >= 1) {
	...
	public boolean android_isMobileElementPresentUsingText_Scroll(String text) {
		log.info("Trying to find element with text - " + text);
		if (wait_until_MobileElementsAre_Present(driver, (MobileBy
				.AndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"" + text + "\"));")))
						.size() >= 1) {
			log.info("element found");
			return true;
	...
	public void pressAndHold(WebElement element1, int timeInSeconds) {
		...
		touch.longPress(PointOption.point(rect1.getX() + rect1.getWidth() / 2, rect1.getY() + rect1.getHeight() / 2))
				.waitAction(waitOptions(Duration.ofSeconds(timeInSeconds))).release().perform();
		log.info("Press and Hold Action performed");
	}

	public void pressElement(MobileElement element, long seconds) {
		new TouchAction(driver).press(element(element)).waitAction(waitOptions(Duration.ofSeconds(seconds))).release()
				.perform();
	}
	...
	public void tap(WebElement element, int milliseconds) {
		new TouchAction(driver).tap(TapOptions.tapOptions().withElement(element(element)))
				.waitAction(waitOptions(Duration.ofMillis(milliseconds))).perform();
	}

	public void tapByCoordinates(int x, int y) {
		new TouchAction(driver).tap(PointOption.point(x, y)).waitAction(waitOptions(Duration.ofMillis(250))).perform();
	}
	...
	public void basicSwipe(WebElement element1, WebElement element2) {
		...
		TouchAction touch = new TouchAction(driver);
		touch.press(PointOption.point(rect1.getX() + rect1.getWidth() / 2, rect1.getY() + rect1.getHeight()))
				.moveTo(PointOption.point(rect2.getX() + rect2.getWidth() / 2, rect2.getY() + rect2.getHeight()))
				.release().perform();
	...
	public void dragDrop(WebElement element1, WebElement element2) {
		...
		TouchAction touch = new TouchAction(driver);
		touch.longPress(PointOption.point(rect1.getX() + rect1.getWidth() / 2, rect1.getY() + rect1.getHeight() / 2))
				.moveTo(PointOption.point(rect2.getX() + rect2.getWidth() / 2, rect2.getY() + rect2.getHeight() / 2))
				.release().perform();
	...
	public WebElement ios_returnMobileElementUsingPredicateString(String predicateString) {
		...
		return wait_until_MobileElementIs_Visible(driver, MobileBy.iOSNsPredicateString(predicateString));
	}
	...
	public boolean ios_isElementPresentUsingAccessibilityId(String acessibilityId) {
		...
		try {
			...
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.AccessibilityId(acessibilityId)), 5)
					.size() >= 1) {
				log.info("element found");
				return true;
			}
	...
	public boolean ios_isElementPresentUsingPredicateString(String predicateString) {
		...
		try {
			log.info("Trying to find element with predicateString - " + predicateString);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.iOSNsPredicateString(predicateString)), 5)
					.size() >= 1) {
				log.info("element found");
				return true;
			}
	...
	public boolean ios_isElementPresentUsingClassChain(String classChain) {
		...
		try {
			log.info("Trying to find element with classChain - " + classChain);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.iOSClassChain(classChain)), 5).size() >= 1) {
				log.info("element found");
				return true;
			}
		} catch (Exception e) {
	...
	public boolean ios_isElementPresentUsingAccessibilityId(String acessibilityId, int timeinSeconds) {

		try {
			log.info("Trying to find element with AcessibilityId - " + acessibilityId);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.AccessibilityId(acessibilityId)), timeinSeconds)
					.size() >= 1) {
				log.info("element found");
				return true;
			}
	...
	public boolean ios_isElementPresentUsingName(String name, int timeinSeconds) {
		...
		try {
			log.info("Trying to find element with name - " + name);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.name(name)), timeinSeconds).size() >= 1) {
				log.info("element found");
				return true;
			}
		} catch (Exception e) {
	...
	public boolean ios_isElementPresentUsingXpath(String xPath, int timeinSeconds) {
		...
		try {
			log.info("Trying to find element with xPath - " + xPath);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.xpath(xPath)), timeinSeconds).size() >= 1) {
				log.info("element found");
				return true;
			}
		} catch (Exception e) {
	...
	public boolean ios_isElementPresentUsingPredicateString(String predicateString, int timeinSeconds) {

		try {
			log.info("Trying to find element with predicateString - " + predicateString);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.iOSNsPredicateString(predicateString)),
					timeinSeconds).size() >= 1) {
				log.info("element found");
				return true;
			}
		} catch (Exception e) {
	...
	public boolean ios_isElementPresentUsingClassChain(String classChain, int timeinSeconds) {
		...
		try {
			log.info("Trying to find element with classChain - " + classChain);
			if (wait_until_MobileElementsAre_Visible(driver, (MobileBy.iOSClassChain(classChain)), timeinSeconds)
					.size() >= 1) {
				log.info("element found");
				return true;
			}
	...
	public void ios_scroll(int starty, int endy) {
		...
		new TouchAction(driver).longPress(PointOption.point(x, start_y)).moveTo(PointOption.point(x, end_y)).release()
				.perform();
		log.info("scroll done");
	}

	public WebElement scrollUsingAndroidContentDescription(String Text) {
		String mySelector = "new UiSelector().description(\"" + Text + "\").instance(0)";
		String command = "new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(" + mySelector
				+ ");";
		wait = new WebDriverWait(driver, 60);
		return wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.AndroidUIAutomator(command)));
	...
	public void scrollNClick(String loc) throws InterruptedException {
		int retry = 0;
		...
		while (retry <= 10) {
			try {
				...
				WebElement ele = wait.until(ExpectedConditions.visibilityOfElementLocated(MobileBy.xpath(loc)));
				if (ele.isDisplayed()) {
					System.out.println("-------Element is under viewport and visible--------");
					ele.click();
					break;
				}
	...
	public void ios_swipeElementToTheLeft(WebElement el) {
		...
		// elements x location is the beginning point of the element , multiplying with
		// 4 to get to the
		// middle part of the element
		new TouchAction(driver).press(PointOption.point(x * 4, y)).waitAction(waitOptions(Duration.ofSeconds(2)))
	...
	public void ios_swipeElementToTheRight(WebElement el) {
		...
		// 4 to get to the
		// middle part of the element
		new TouchAction(driver).press(PointOption.point(x, y)).waitAction(waitOptions(Duration.ofSeconds(2)))
				.moveTo(PointOption.point(x * 4, y)).release().perform();
	...
	public void zoom_Using_MultiTouchActions() {
		...
		touch1.press(PointOption.point(halfHeight, halfHeight)).waitAction(waitOptions(Duration.ofSeconds(1)))
				.moveTo(PointOption.point(0, 60)).release();
		touch2.press(PointOption.point(halfHeight, halfHeight + 40)).waitAction(waitOptions(Duration.ofSeconds(1)))
				.moveTo(PointOption.point(0, 80)).release();
	...
	// WAIT FOR MAX TIME 60 SECS TILL SELENIUM FINDS 2 WINDOWS
	...
	public void hoverClickAndPressEnter(WebDriver driver, By locator) {
		Actions action = new Actions(driver);
		action.moveToElement(wait_until_ElementIs_Visible(driver, locator)).click().sendKeys(Keys.ENTER).build()
				.perform();
		waitForPageToLoad(driver);
	}
	...
	public void hoverClickAndSendData(WebDriver driver, By locator, String data) {
		Actions action = new Actions(driver);
		action.moveToElement(wait_until_ElementIs_Visible(driver, locator)).click().sendKeys(data).build().perform();
		waitForPageToLoad(driver);
	}
	...
	public void hoverClickSendDataAndPressEnter(WebDriver driver, By locator, String data) {
		Actions action = new Actions(driver);
		action.moveToElement(wait_until_ElementIs_Visible(driver, locator)).click().sendKeys(data).sendKeys(Keys.ENTER)
				.build().perform();
		waitForPageToLoad(driver);
	}
	...
	public void hoverAndSendData(WebDriver driver, By locator, String data) {
		Actions action = new Actions(driver);
		action.moveToElement(wait_until_ElementIs_Visible(driver, locator)).sendKeys(data).build().perform();
		waitForPageToLoad(driver);
	}
	...
	public void dragAndDropToElementContainner(WebDriver driver, WebElement source, WebElement target) {
		Actions builder = new Actions(driver);
	...
	public void switchToNewWindowHandle_After_ClickingOnGivenElement(WebDriver driver, By locator) {
		...
		if (driver.getWindowHandles().size() >= 2) { // switch to a new window handle if there more than 1 window
														// handles.
